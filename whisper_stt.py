...
# os.environ["PATH"] += os.pathsep + r"C:\ProgramData\anaconda3\envs\llm\Library\bin" # 자신이 설치한 위치로 경로 수정
...
if __name__ == "__main__":
    audio_file_path = r'C:\Users\kim\llm-programming\싼기타_비싼기타.mp3'      # 원본 오디오 파일
